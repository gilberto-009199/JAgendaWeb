...
public class Conexao {
	...
	/*public static Connection getConexao() {
		...
		try {
			...
			Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
				...
				conet = DriverManager.getConnection("jdbc:ucanaccess://db.accdb");

		} catch (Exception e) {

			System.out.println(" Erro ao conectar ao banco: " + e.getMessage());
		}
		//System.out.println("banco conectado com sucelso!");
		return conet;
	}*/
	...
	public static Connection getConexao(){
		 ...
		 try{
	        ...
	        conet = DriverManager.getConnection("jdbc:sqlite:banco.sqlite");
